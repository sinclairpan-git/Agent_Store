    ...
    def apply_lifecycle_transition(
        ...
        *,
        ...
        if not isinstance(current_version, Mapping):
            return 400, self._validation_error(
                trace_id,
                recommended_action_id="attach_current_version",
                details={"reason": "current_version must be an object"},
            )
        ...
        response = build_lifecycle_governance_baseline(
